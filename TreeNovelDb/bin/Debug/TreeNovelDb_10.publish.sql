...
GO
PRINT N'Altering [dbo].[Chapter]...';


GO
ALTER TABLE [dbo].[Chapter]
    ADD [CategoryName] VARCHAR (100) NULL;
...
ALTER TABLE [dbo].[Chapter] WITH NOCHECK
    ADD FOREIGN KEY ([CategoryName]) REFERENCES [dbo].[Category] ([Name]);
...
DECLARE tableconstraintnames CURSOR LOCAL FORWARD_ONLY
    FOR SELECT SCHEMA_NAME([schema_id]),
               ...
               0
        FROM   [sys].[objects]
        WHERE  [parent_object_id] IN (OBJECT_ID(N'dbo.Chapter'))
               AND [type] IN (N'F', N'C')
