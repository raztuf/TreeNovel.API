...
GO
/*
The column [dbo].[User].[IsMod] is being dropped, data loss could occur.
*/
...
GO
ALTER TABLE [dbo].[Chapter] DROP CONSTRAINT [FK__Chapter__UserId__6A30C649];
...
GO
ALTER TABLE [dbo].[Comment] DROP CONSTRAINT [FK__Comment__UserId__6E01572D];
...
GO
ALTER TABLE [dbo].[Discussion] DROP CONSTRAINT [FK__Discussio__UserI__6EF57B66];
...
IF EXISTS (SELECT TOP 1 1 
    ...
    BEGIN
        ...
        INSERT INTO [dbo].[tmp_ms_xx_User] ([Id], [Username], [Mail], [Password], [IsActive])
        SELECT   [Id],
                 [Username],
                 [Mail],
                 [Password],
...
DECLARE tableconstraintnames CURSOR LOCAL FORWARD_ONLY
    FOR SELECT SCHEMA_NAME([schema_id]),
               ...
               0
        FROM   [sys].[objects]
        WHERE  [parent_object_id] IN (OBJECT_ID(N'dbo.Chapter'), OBJECT_ID(N'dbo.Comment'), OBJECT_ID(N'dbo.Discussion'))
               AND [type] IN (N'F', N'C')
