...
GO
PRINT N'Dropping [dbo].[FK__Chapter__LastCha__48CFD27E]...';
...
GO
PRINT N'Dropping [dbo].[FK__Discussio__Reply__4BAC3F29]...';


GO
ALTER TABLE [dbo].[Discussion] DROP CONSTRAINT [FK__Discussio__Reply__4BAC3F29];
...
ALTER TABLE [dbo].[Discussion] WITH NOCHECK
    ADD FOREIGN KEY ([ReplyToId]) REFERENCES [dbo].[Discussion] ([Id]);
...
DECLARE tableconstraintnames CURSOR LOCAL FORWARD_ONLY
    FOR SELECT SCHEMA_NAME([schema_id]),
               ...
               0
        FROM   [sys].[objects]
        WHERE  [parent_object_id] IN (OBJECT_ID(N'dbo.Chapter'), OBJECT_ID(N'dbo.Discussion'))
               AND [type] IN (N'F', N'C')
